  ...
  public class Parva {
    ...
    public static void Main (string[] args) {
      ...
      for (int i = 0; i < args.Length; i++) {
		...
		//else if (args[i].ToLower().Equals("-c")) Parser.cod = true if ((args[i+1].ToLower().Equals("-1")) mergeErrors = true;
      ...
      if (Parser.cod == true) PVM.ListCode(codeName, codeLength);
      Exception BR = System.GETLAS
