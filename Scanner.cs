...
public class Scanner {
	...
	const int do_Sym = 25;
	const int for_Sym = 26;
	const int in_Sym = 27;
	const int halt_Sym = 28;
	const int return_Sym = 29;
	const int read_Sym = 30;
	const int readLine_Sym = 31;
	const int write_Sym = 32;
	const int plus_Sym = 33;
	const int writeLine_Sym = 34;
	const int minus_Sym = 35;
	const int new_Sym = 36;
	const int bang_Sym = 37;
	const int barbar_Sym = 38;
	const int star_Sym = 39;
	const int slash_Sym = 40;
	const int percent_Sym = 41;
	const int andand_Sym = 42;
	const int equalequal_Sym = 43;
	const int bangequal_Sym = 44;
	const int less_Sym = 45;
	const int lessequal_Sym = 46;
	const int greater_Sym = 47;
	const int greaterequal_Sym = 48;
	const int equal_Sym = 49;
	const int NOT_SYM = 50;
	// pragmas
	const int DebugOn_Sym = 51;
	const int DebugOff_Sym = 52;
	const int StackDump_Sym = 53;
	const int HeapDump_Sym = 54;
	const int TableDump_Sym = 55;
	const int codon_Sym = 56;
	const int codoff_Sym = 57;
	const int warningoff_Sym = 58;
