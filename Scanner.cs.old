...
public class Scanner {
	...
	const int break_Sym = 12;
	const int const_Sym = 13;
	const int true_Sym = 14;
	const int false_Sym = 15;
	const int null_Sym = 16;
	const int lbrackrbrack_Sym = 17;
	const int int_Sym = 18;
	const int bool_Sym = 19;
	const int lbrack_Sym = 20;
	const int rbrack_Sym = 21;
	const int if_Sym = 22;
	const int else_Sym = 23;
	const int while_Sym = 24;
	const int do_Sym = 25;
	const int halt_Sym = 26;
	const int return_Sym = 27;
	const int read_Sym = 28;
	const int readLine_Sym = 29;
	const int write_Sym = 30;
	const int plus_Sym = 31;
	const int writeLine_Sym = 32;
	const int minus_Sym = 33;
	const int new_Sym = 34;
	const int bang_Sym = 35;
	const int barbar_Sym = 36;
	const int star_Sym = 37;
	const int slash_Sym = 38;
	const int percent_Sym = 39;
	const int andand_Sym = 40;
	const int equalequal_Sym = 41;
	const int bangequal_Sym = 42;
	const int less_Sym = 43;
	const int lessequal_Sym = 44;
	const int greater_Sym = 45;
	const int greaterequal_Sym = 46;
	const int equal_Sym = 47;
	const int NOT_SYM = 48;
	// pragmas
	const int DebugOn_Sym = 49;
	const int DebugOff_Sym = 50;
	const int StackDump_Sym = 51;
	const int HeapDump_Sym = 52;
	const int TableDump_Sym = 53;
	const int codon_Sym = 54;
	const int codoff_Sym = 55;
	const int warningoff_Sym = 56;
	...
	static Token NextToken() {
		...
		switch (state) {
			...
			case 17:
				{ t.kind = codon_Sym; goto done; }
			case 18:
				{ t.kind = codoff_Sym; goto done; }
			case 19:
				if (ch == '-') { buf.Append(ch); NextCh(); goto case 20; }
				else { t.kind = noSym; goto done; }
			case 20:
				{ t.kind = warningoff_Sym; goto done; }
			case 21:
